...
\begin{lstlisting}
$ wget https://github.com/Ninad-Meshram/ASSIGNMENT1_EE3900/blob/main/pingala/codes/1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/Ninad-Meshram/ASSIGNMENT1_EE3900/blob/main/pingala/codes/2_1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/Ninad-Meshram/ASSIGNMENT1_EE3900/blob/main/pingala/codes/2_2.py
\end{lstlisting}
